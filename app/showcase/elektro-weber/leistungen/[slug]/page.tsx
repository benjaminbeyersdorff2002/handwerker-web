...
import { services, references } from "@/data/elektro-weber";
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-600 rounded-2xl p-6 text-white">
                ...
                <Link
                  href={`${base}/kontakt`}
                  className="flex items-center justify-center gap-2 w-full py-3 bg-yellow-400 text-blue-900 font-bold rounded-xl hover:bg-yellow-300 transition-colors"
                >
                  Jetzt anfragen
              ...
              <div className="bg-gray-50 rounded-2xl p-6">
                ...
                <ul className="space-y-2">
                    ...
                    .map((s) => (
                      <li key={s.slug}>
                        <Link
                          ...
                          className="flex items-center gap-2 text-sm text-gray-600 hover:text-blue-600 transition-colors py-1.5"
                        >
                  ...
                  <li>
                    <Link
                      href={`${base}/notdienst`}
                      className="flex items-center gap-2 text-sm text-red-600 hover:text-red-700 transition-colors py-1.5 font-medium"
                    >
                      <ArrowRight className="h-3.5 w-3.5" />
                      24h Notdienst
                    </Link>
              ...
              <div className="grid md:grid-cols-2 gap-8 mt-6 items-center">
                ...
                <div>
                  ...
                  <Link
                    ...
                    className="mt-4 inline-flex items-center gap-2 text-blue-600 font-semibold text-sm hover:text-blue-700 transition-colors"
                  >
