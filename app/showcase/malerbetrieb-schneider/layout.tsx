...
import Footer from "@/components/showcase/maler-schneider/Footer";

export const metadata: Metadata = {
  title: {
    template: "%s | Malerbetrieb Schneider",
    default:
      "Malerbetrieb Schneider | Maler & Lackierer in Herborn",
  },
  description:
    "Innenmalerei, Fassadengestaltung, Lackierarbeiten und Kreativtechniken in Herborn und Umgebung. Familienbetrieb seit 2004.",
};

export default function MalerSchneiderLayout({
  children,
}: {
      ...
      <div className="py-4 bg-amber-50 border-t border-amber-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            Zurück zur Showcase-Übersicht – Diese Demo wurde mit
            CraftBridge erstellt
          </Link>
        </div>
      </div>
    </div>
