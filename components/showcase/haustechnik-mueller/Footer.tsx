...
import { companyInfo, services } from "@/data/haustechnik-mueller";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Ihr SHK-Meisterbetrieb in {companyInfo.region}. Sanitär, Heizung &
              Klimatechnik – seit 2001 in 2. Generation.
            </p>
          </div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li>
                <Link
                  ...
                  className="hover:text-red-400 transition-colors text-red-300 font-medium"
                >
                  HeizungsCheck
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>{companyInfo.street}, {companyInfo.zip} {companyInfo.city}</span>
              </li>
            </ul>
